    ...
    <div class="relative mb-[100px]">
        <div class="md:flex md:flex-row">
            <div class="md:w-[60%] md:mr-4 mb-4">
                <label for="type_id" class="block mb-2 w-full">{{__('leads.add_product')}}<span class="text-red-600"> (*)</label></label>
            ...
            <div class="md:w-[20%]">
                <label class="hidden md:block mb-2 w-full" for="buttonAdd">{{__('leads.table_action')}}</label>
           ...
           @foreach ($selectedProducts as $index => $product)
            <div class=" flex flex-row mb-4" key="{{ $index }}">
                ...
                <div class="w-[20%]">
                    ...
                    wire:click="removeProduct({{ $index }})">{{__('leads.delete')}}</button>
                </div>
            </div>
            @endforeach
        @else
