...
<div class="bg-white rounded-xl p-4 dark:bg-gray-800 mb-4">
    ...
    <div class="flex flex-row justify-between my-4 border-y md:border-y-0 border-gray-300  pb-2">
        ...
        <div class="flex flex-row items-center">
            ...
            <select
            wire:model.live.debounce.300ms="currentYear" 
            ...
            <select 
            wire:model.live.debounce.300ms="currentMonth" 
        ...
        <tbody>
            @if(count($leads)==0)
                <tr 
                    ...
                    <td colspan="5" class="whitespace-nowrap px-2 py-2 text-center">{{__('reports.no_data')}}</td>
                </tr>
            @endif
            @foreach ($leads as $item)
                ...
                hover:bg-gray-200 dark:border-neutral-500 dark:hover:bg-neutral-600">
                    ...
                    <td class="whitespace-nowrap px-2 py-2">{{ getClientName($item->client_id) }}</td>
